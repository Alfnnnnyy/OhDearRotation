...
NewUpdate = false -- BOT BAKAL LEVELING SEBELUM PNB UNTUK COUNTER NEW PATCH.
Leveling = false -- BOT AKAN LEVELING MENGGUNAKAN WINDOW, APABILA FALSE BOT AKAN LEVELING DENGAN CARA HARVEST FARM UTAMA!
...
ControlViaDC = true
TimeRelogBotMatung = 8 --JIKA TIDAK ADA AKTIVITAS SELAMA 7 MENIT, AUTO RELOG
